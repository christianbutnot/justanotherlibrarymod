...
public class CustomExcavatorItem extends DiggerItem {
	...
	public CustomExcavatorItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
		super(pTier, BlockTags.MINEABLE_WITH_SHOVEL, pProperties.attributes(createAttributes(pTier, 2F, -3F)));
	}
